        ...
        <div class="col-lg-9">
            ...
            <?php if (empty($products)): ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?= base_url('produtos') ?>" class="btn btn-outline-secondary">Limpar filtros</a>
                    ...
                    <div class="mt-4 p-4 bg-light rounded">
                        ...
                        <?php if (setting('store_whatsapp')): ?>
                            <a href="https://wa.me/<?= setting('store_whatsapp') ?>?text=<?= urlencode('Olá! Estou procurando um produto que não encontrei no site.') ?>" target="_blank" class="btn btn-success">
